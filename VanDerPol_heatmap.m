...
for ieps = 1:length(epsL)
    ...
    for idt = 1:length(tEndL)
        ...
        [t,x_clean]=ode89(@(t,x) vanderpol(t,x,param),tspan,x0,options);
        ...
        %% Store outputs
            ...
            if saveTrue
                ...
                save([num2str(iii) '_VanDerPol_SuccessRate_heatmap.mat'],...
...
save('Full_VanDerPol_SuccessRate_heatmap.mat','-v7.3');
return
